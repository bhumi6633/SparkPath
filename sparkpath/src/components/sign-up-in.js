                    ...
                    <div className="su-toggle-container">
                        {props.signIn ? (
                            <p className="su-toggle-text">
                                ...
                                <button onClick={() => props.setSignIn(false)} className="su-toggle-button">Sign Up</button>
                            </p>
                        ) : (
                            <p className="su-toggle-text">
                                Already have an account?{' '}
                                <button onClick={() => props.setSignIn(true)} className="su-toggle-button">Sign In</button>
                            </p>
                        )}
                    </div>
                </div>
